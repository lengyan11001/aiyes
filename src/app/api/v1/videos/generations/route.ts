...
const schema = z.object({
  ...
  video_files: z.array(z.string().url()).min(1).max(3).optional(),
  audio_files: z.array(z.string().url()).min(1).max(3).optional(),
  ...
  functionMode: z.enum(["omini", "first_last_frame"]).optional(),
